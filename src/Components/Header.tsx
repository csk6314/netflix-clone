...
const Item = styled.li<{matched:boolean}>`
    margin-right: 20px;
  color: ${(props) => props.matched ? props.theme.white.lighter : props.theme.white.darker};
  font-weight:${(props)=>props.matched &&'bold'};
    ...
    return (
        ...
        >
            <Col>
                ...
                <Items>
                    <Link to="/">
                    <Item matched={homeMatch !== null}>Home</Item>
                    </Link>
                    <Link to="/tv">
                    <Item matched={tvMatch!==null}>TV Shows</Item>
                    </Link>
                </Items>
            </Col>
            <Col>
